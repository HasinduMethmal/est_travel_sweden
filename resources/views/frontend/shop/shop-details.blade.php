            ...
            <div class="row gx-60">
                <div class="col-lg-6">
                    <div class="product-big-img">
                        <div class="img"><img src="frontend/assets/img/product/product_details_1_1.png" alt="Product Image"></div>
                    </div>
                </div>
                        ...
                        <div class="th-comments-wrap ">
                            <ul class="comment-list">
                                ...
                                <li class="review th-comment-item">
                                    <div class="th-post-comment">
                                        <div class="comment-avater">
                                            <img src="frontend/assets/img/blog/comment-author-4.jpg" alt="Comment Author">
                                        </div>
                                        <div class="comment-content">
                ...
                <div class="swiper th-slider has-shadow" id="productSlider1" data-slider-options='{"breakpoints":{"0":{"slidesPerView":1},"576":{"slidesPerView":"2"},"768":{"slidesPerView":"2"},"992":{"slidesPerView":"3"},"1200":{"slidesPerView":"4"}}}'>
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide style2">
                            <div class="th-product">
                                <div class="product-img">
                                    <img src="frontend/assets/img/product/product_1_2.png" alt="Product Image">
                                    <span class="product-tag">Sale</span>
                                    <div class="actions">
                                        <a href="#QuickView" class="icon-btn popup-content"><i class="far fa-eye"></i></a>
                                        <a href="cart.html" class="icon-btn"><i class="far fa-cart-plus"></i></a>
                        ...
                        <div class="swiper-slide style2">
                            <div class="th-product">
                                <div class="product-img">
                                    <img src="frontend/assets/img/product/product_1_3.png" alt="Product Image">
                        ...
                        <div class="swiper-slide style2">
                            <div class="th-product">
                                <div class="product-img">
                                    <img src="frontend/assets/img/product/product_1_4.png" alt="Product Image">
                                    <span class="product-tag">Sale</span>
                                    <div class="actions">
                                        <a href="#QuickView" class="icon-btn popup-content"><i class="far fa-eye"></i></a>
                                        <a href="cart.html" class="icon-btn"><i class="far fa-cart-plus"></i></a>
                        ...
                        <div class="swiper-slide style2">
                            <div class="th-product">
                                <div class="product-img">
                                    <img src="frontend/assets/img/product/product_1_5.png" alt="Product Image">
                                    <span class="product-tag">New</span>
                                    <div class="actions">
                                        <a href="#QuickView" class="icon-btn popup-content"><i class="far fa-eye"></i></a>
                                        <a href="cart.html" class="icon-btn"><i class="far fa-cart-plus"></i></a>
                        ...
                        <div class="swiper-slide style2">
                            <div class="th-product">
                                <div class="product-img">
                                    <img src="frontend/assets/img/product/product_1_6.png" alt="Product Image">
                                    <span class="product-tag">Sale</span>
                                    <div class="actions">
                                        <a href="#QuickView" class="icon-btn popup-content"><i class="far fa-eye"></i></a>
                                        <a href="cart.html" class="icon-btn"><i class="far fa-cart-plus"></i></a>
                        ...
                        <div class="swiper-slide style2">
                            <div class="th-product">
                                <div class="product-img">
                                    <img src="frontend/assets/img/product/product_1_7.png" alt="Product Image">
                                    <span class="product-tag">New</span>
                                    <div class="actions">
                                        <a href="#QuickView" class="icon-btn popup-content"><i class="far fa-eye"></i></a>
                                        <a href="cart.html" class="icon-btn"><i class="far fa-cart-plus"></i></a>
                        ...
                        <div class="swiper-slide style2">
                            <div class="th-product">
                                <div class="product-img">
                                    <img src="frontend/assets/img/product/product_1_8.png" alt="Product Image">
                                    <span class="product-tag">Sale</span>
                                    <div class="actions">
                                        <a href="#QuickView" class="icon-btn popup-content"><i class="far fa-eye"></i></a>
                                        <a href="cart.html" class="icon-btn"><i class="far fa-cart-plus"></i></a>
