...
<head>
    ...
    <link rel="apple-touch-icon" sizes="57x57"   href="{{ asset('backend/assets/img/favicon/favicon.ico') }}" >
    <link rel="apple-touch-icon" sizes="60x60"  href="{{ asset('backend/assets/img/favicon/favicon.ico') }}" >
    <link rel="apple-touch-icon" sizes="72x72"  href="{{ asset('backend/assets/img/favicon/favicon.ico') }}" >
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('backend/assets/img/favicon/favicon.ico') }}" >
    <link rel="apple-touch-icon" sizes="114x114"  href="{{ asset('backend/assets/img/favicon/favicon.ico') }}" >
    <link rel="apple-touch-icon" sizes="120x120"  href="{{ asset('backend/assets/img/favicon/favicon.ico') }}" >
    <link rel="apple-touch-icon" sizes="144x144"  href="{{ asset('backend/assets/img/favicon/favicon.ico') }}" >
    <link rel="apple-touch-icon" sizes="152x152"  href="{{ asset('backend/assets/img/favicon/favicon.ico') }}" >
    <link rel="apple-touch-icon" sizes="180x180"  href="{{ asset('backend/assets/img/favicon/favicon.ico') }}" >
    <link rel="icon" type="image/png" sizes="192x192"  href="{{ asset('backend/assets/img/favicon/favicon.ico') }}" >
    <link rel="icon" type="image/png" sizes="32x32"  href="{{ asset('backend/assets/img/favicon/favicon.ico') }}"  >
    <link rel="icon" type="image/png" sizes="96x96"  href="{{ asset('backend/assets/img/favicon/favicon.ico') }}" >
    <link rel="icon" type="image/png" sizes="16x16"  href="{{ asset('backend/assets/img/favicon/favicon.ico') }}" >
