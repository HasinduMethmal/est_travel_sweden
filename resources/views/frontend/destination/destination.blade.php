...
<div class="breadcumb-wrapper background-image" data-bg-src="url({{ asset('frontend/images/destination_1.png') }})">
    <div class="container">
                ...
                <div class="col-md-4">
                    <div class="search-form-area">
                        <form class="search-form">
                            <input type="text" placeholder="Search" fdprocessedid="47xccp">
                            <button type="submit" fdprocessedid="itr1bo"><i class="fa-light fa-magnifying-glass"></i></button>
                        </form>
                    </div>
                </div>
                ...
                <div class="col-md-auto">
                    <div class="sorting-filter-wrap">
                        ...
                        <form class="woocommerce-ordering" method="get">
                            <select name="orderby" class="orderby" aria-label="destination order" fdprocessedid="15isk3">
            ...
            <div class="col-xxl-9 col-lg-8">
                    ...
                    <div class="tab-pane fade active show" id="tab-grid" role="tabpanel" aria-labelledby="tab-destination-grid">
                        <div class="row gy-30">
                            <div class="col-xxl-4 col-xl-6">
                                <div class="tour-box th-ani">
                                    <div class="tour-box_img global-img">
                                        <img src="{{asset('frontend/assets/img/tour/tour_3_1.jpg')}}" alt="image">
                                    </div>
                                    <div class="tour-content">
                                        ...
                                        <div class="tour-action">
                                            ...
                                            <a href="contact.html" class="th-btn style4 th-icon">Deatil View</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-4 col-xl-6">
                                <div class="tour-box th-ani">
                                    <div class="tour-box_img global-img">
                                        <img src="{{asset('frontend/assets/img/tour/tour_3_2.jpg')}}" alt="image">
                                    </div>
                                    <div class="tour-content">
                                        ...
                                        <div class="tour-action">
                                            <span><i class="fa-light fa-clock"></i>7 Days</span>
                                            <a href="contact.html" class="th-btn style4 th-icon">Detail View</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-4 col-xl-6">
                                <div class="tour-box th-ani">
                                    <div class="tour-box_img global-img">
                                        <img src="{{asset('frontend/assets/img/tour/tour_3_3.jpg')}}" alt="image">
                                    </div>
                                    <div class="tour-content">
                            ...
                            <div class="col-xxl-4 col-xl-6">
                                <div class="tour-box th-ani">
                                    <div class="tour-box_img global-img">
                                        <img src="{{asset('frontend/assets/img/tour/tour_3_4.jpg')}}" alt="image">
                                    </div>
                                    <div class="tour-content">
                            ...
                            <div class="col-xxl-4 col-xl-6">
                                <div class="tour-box th-ani">
                                    <div class="tour-box_img global-img">
                                        <img src="{{asset('frontend/assets/img/tour/tour_3_5.jpg')}}" alt="image">
                                    </div>
                                    <div class="tour-content">
                            ...
                            <div class="col-xxl-4 col-xl-6">
                                <div class="tour-box th-ani">
                                    <div class="tour-box_img global-img">
                                        <img src="{{asset('frontend/assets/img/tour/tour_3_6.jpg')}}" alt="image">
                                    </div>
                                    <div class="tour-content">
                            ...
                            <div class="col-xxl-4 col-xl-6">
                                <div class="tour-box th-ani">
                                    <div class="tour-box_img global-img">
                                        <img src="{{asset('frontend/assets/img/tour/tour_3_7.jpg')}}" alt="image">
                                    </div>
                                    <div class="tour-content">
                            ...
                            <div class="col-xxl-4 col-xl-6">
                                <div class="tour-box th-ani">
                                    <div class="tour-box_img global-img">
                                        <img src="{{asset('frontend/assets/img/tour/tour_3_8.jpg')}}" alt="image">
                                    </div>
                                    <div class="tour-content">
                            ...
                            <div class="col-xxl-4 col-xl-6">
                                <div class="tour-box th-ani">
                                    <div class="tour-box_img global-img">
                                        <img src="{{asset('frontend/assets/img/tour/tour_3_9.jpg')}}" alt="image">
                                    </div>
                                    <div class="tour-content">
                ...
                <div class="th-pagination text-center mt-60 mb-0">
                    <ul>
                        ...
                        <li><a class="next-page" href="destination.html">Next <img src="{{asset('frontend/assets/img/icon/arrow-right4.svg')}}" alt=""></a></li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="widget widget_offer background-image" data-bg-src=" url({{asset('frontend/assets/img/bg/widget_bg_1.jpg')}});">
