...
<div class="breadcumb-wrapper background-image" style="background-image: url({{ asset('frontend/images/destination_1.png') }});">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xxl-3 col-lg-4">
                <aside class="sidebar-area style2">
                    ...
                    <div class="widget widget_offer background-image" style="background-image: url({{asset('frontend/assets/img/bg/widget_bg_1.jpg')}});">
