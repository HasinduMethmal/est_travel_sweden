  ...
  <div id="preloader" class="preloader ">
        ...
        <div class="preloader-inner">
            <img src="frontend/assets/img/logo3.svg" alt="">
        </div>
            ...
            <div class="widget  ">
                <div class="th-widget-about">
                    <div class="about-logo">
                        <a href="home-travel.html"><img src="frontend/assets/img/logo2.svg" alt="Tourm"></a>
                    </div>
    ...
    <div class="header-top">
        ...
        <div class="sticky-wrapper">
            ...
            <div class="menu-area">
                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-auto">
                            <div class="header-logo">
                                <a href="home-travel.html"><img src="frontend/assets/img/logo.svg" alt="Tourm"></a>
                            </div>
                        </div>
                ...
                <div class="logo-bg" data-mask-src="frontend/assets/img/logo_bg_mask.png"></div>
            </div>
        </div>
    </header>