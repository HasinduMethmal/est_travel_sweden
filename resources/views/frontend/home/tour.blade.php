...
@section ('title', 'home_tou')

@section('content')


<div class="hero-2" id="hero">
    <div class="hero2-overlay" data-bg-src="{{asset('frontend/assets/img/bg/line-pattern.png')}}"></div>
    <div class="swiper hero-slider-2" id="heroSlide2">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="hero-inner">
                    <div class="th-hero-bg" data-bg-src="{{asset('frontend/assets/img/hero/hero_bg_2_1.jpg')}}">
                    </div>
                    <div class="container">
                        <div class="hero-style2">
                            ...
                            <p class="hero-desc" data-ani="slideinup" data-ani-delay="0.5s">
                                Tourm an international travel management company with 25 years of experience,
                                specializing in business and maritime travel.
                            </p>
                            <div class="btn-group" data-ani="slideinup" data-ani-delay="0.6s">
                                <a href="destination.html" class="th-btn white-btn th-icon">Explore Tours</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="swiper-slide">
                <div class="hero-inner">
                    <video autoplay loop muted>
                        <source src="{{asset('frontend/assets/img/hero/hero-video.mp4')}}" type="video/mp4">
                    </video>
            ...
            <div class="swiper-slide">
                <div class="hero-inner">
                    <div class="th-hero-bg" data-bg-src="{{asset('frontend/assets/img/hero/hero_bg_2_3.jpg')}}">
                    </div>

                    <div class="container">
                        <div class="hero-style2">
                            <h1 class="hero-title" data-ani="slideinup" data-ani-delay="0.4s">
                                Enjoy<span class="hero-text">The Most Enjoyable Journey </span>
                            </h1>
                            <p class="hero-desc" data-ani="slideinup" data-ani-delay="0.5s">
                                Tourm an international travel management company with 25 years of experience,
                                specializing in business and maritime travel.
        ...
        <div class="th-swiper-custom">
            ...
            <div class="hero-icon">
                <button data-slider-prev="#heroSlide2, #heroSlide3" class="hero-arrow slider-prev"><img src="{{asset('frontend/assets/img/icon/hero-arrow-left.svg')}}" alt=""></button>
                <button data-slider-next="#heroSlide2, #heroSlide3" class="hero-arrow slider-next"><img src="{{asset('frontend/assets/img/icon/hero-arrow-right.svg')}}" alt=""></button>
            </div>
        </div>
    </div>
        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="hero-inner">
                    <div class="hero-card">
                        <div class="hero-img">
                            <img src="{{asset('frontend/assets/img/hero/hero_bg_2_1.jpg')}}" alt="">
                        </div>
            ...
            <div class="swiper-slide">
                <div class="hero-inner">
                    <div class="hero-card">
                        <div class="hero-img">
                            <img src="{{asset('frontend/assets/img/hero/hero_bg_2_2.jpg')}}" alt="">
                        </div>
                        <div class="hero-card_content">
            ...
            <div class="swiper-slide">
                <div class="hero-inner">
                    <div class="hero-card">
                        <div class="hero-img">
                            <img src="{{asset('frontend/assets/img/hero/hero_bg_2_3.jpg')}}" alt="">
                        </div>
                        <div class="hero-card_content">
                            <h3 class="box-title">Mountain Tour</h3>
                            <h4 class="hero-card_price"><span class="currency">$850.00</span>/Person</h4>
    ...
    <div class="scroll-down">
        <a href="#destination-sec" class="scroll-wrap"><span><img src="{{asset('frontend/assets/img/icon/down-arrow.svg')}}" alt=""></span>
            Scroll
            Down</a>
    </div>
</div>

<div class="destination-area bg-top-center position-relative space" id="destination-sec" data-bg-src="{{asset('frontend/assets/img/bg/line-pattern2.png')}}">
    <div class="container">
        ...
        <div class="row">
            <div class="destination-list-area">
                <div class="destination-list-wrap">
                    <div class="destination-list" data-bg-src="{{asset('frontend/assets/img/destination/destination_2_1.jpg')}}">
                ...
                <div class="destination-list-wrap">
                    <div class="destination-list" data-bg-src="{{asset('frontend/assets/img/destination/destination_2_2.jpg')}}">
                        <div class="destination-content">
                            <h4 class="box-title">
                ...
                <div class="destination-list-wrap">
                    <div class="destination-list" data-bg-src="{{asset('frontend/assets/img/destination/destination_2_3.jpg')}}">
                        <div class="destination-content">
                            <h4 class="box-title">
                ...
                <div class="destination-list-wrap active">
                    <div class="destination-list" data-bg-src="{{asset('frontend/assets/img/destination/destination_2_4.jpg')}}">
                        <div class="destination-content">
                            <h4 class="box-title">
        ...
        <div class="swiper categorySlider2" id="categorySlide2">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="category-card single2">
                        <div class="box-img global-img">
                            <img src="{{asset('frontend/assets/img/category/category_1_1.jpg')}}" alt="Image">
                        </div>
                ...
                <div class="swiper-slide">
                    <div class="category-card single2">
                        <div class="box-img global-img">
                            <img src="{{asset('frontend/assets/img/category/category_1_2.jpg')}}" alt="Image">
                        </div>
                ...
                <div class="swiper-slide">
                    <div class="category-card single2">
                        <div class="box-img global-img">
                            <img src="{{asset('frontend/assets/img/category/category_1_3.jpg')}}" alt="Image">
                        </div>
                ...
                <div class="swiper-slide">
                    <div class="category-card single2">
                        <div class="box-img global-img">
                            <img src="{{asset('frontend/assets/img/category/category_1_4.jpg')}}" alt="Image">
                        </div>
                ...
                <div class="swiper-slide">
                    <div class="category-card single2">
                        <div class="box-img global-img">
                            <img src="{{asset('frontend/assets/img/category/category_1_5.jpg')}}" alt="Image">
                        </div>
...
<section class=" position-relative overflow-hidden space">
    <div class="container">
        <div class="offer-deals-accordion">
            <div class="row">
                <div class="col-xl-7">
                    <div class="offer-deals-wrapp">
                        <div class="accordion-item-wrapp" id="offerDeals">
                                        ...
                                        <div class="accordion-header" id="collapse-item-1">
                                            <button class="accordion-button " data-bs-toggle="collapse" data-bs-target="#collapse-1" aria-expanded="true" aria-controls="collapse-1">
                                                <span class="accordion-item_info">
                                                    <span class="box-title"> Himalay, Nepal</span>
                                                    <i class="fa-thin fa-angle-down"></i>
                                                </span>

                                            </button>
                                        </div>
                                        <div id="collapse-1" class="accordion-collapse collapse show" aria-labelledby="collapse-item-1" data-bs-parent="#offerDeals">
                                            <div class="accordion-body">
                                                <span class="faq-price">$499.00 USD</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="accordion-item-content">
                                <div class="accordion-tab-item" data-bs-toggle="tab" data-bs-target="#tab2">
                                    <div class="accordion-item" data-img="{{asset('frontend/assets/img/normal/offer_img_2.jpg')}}">
                                        <div class="accordion-header" id="collapse-item-2">
                                            <div class="accordion-button collapsed" role="button" data-bs-toggle="collapse" data-bs-target="#collapse-2" aria-expanded="false" aria-controls="collapse-2">
                                                <span class="accordion-item_info">
                                                    <span class="box-title">Ashi Lake Hakone, Japan</span>
                                                    <i class="fa-thin fa-angle-down"></i>
                                                </span>

                                            </div>
                                        </div>
                                        <div id="collapse-2" class="accordion-collapse collapse " aria-labelledby="collapse-item-2" data-bs-parent="#offerDeals">
                                            <div class="accordion-body">
                                                <span class="faq-price">$465.11</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item-content">
                                    <div class="accordion-tab-item" data-bs-toggle="tab" data-bs-target="#tab3">
                                        <div class="accordion-item " data-img="{{asset('frontend/assets/img/normal/offer_img_3.jpg')}}">
                                            <div class="accordion-header" id="collapse-item-3">
                                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-3" aria-expanded="false" aria-controls="collapse-3">
                                                    <span class="accordion-item_info">
                                                        <span class="box-title">Coxbazar, Bangladesh</span>
                                                        <i class="fa-thin fa-angle-down"></i>
                                                    </span>

                                                </button>
                                            </div>
                                            <div id="collapse-3" class="accordion-collapse collapse " aria-labelledby="collapse-item-3" data-bs-parent="#offerDeals">
                                                <div class="accordion-body">
                                                    <span class="faq-price">8,200 tk</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="accordion-item-content">
                                    <div class="accordion-tab-item" data-bs-toggle="tab" data-bs-target="#tab4">
                                        <div class="accordion-item" data-img="{{asset('frontend/assets/img/normal/offer_img_4.jpg')}}">
                                            <div class="accordion-header" id="collapse-item-4">
                                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-4" aria-expanded="false" aria-controls="collapse-4">
                                                    <span class="accordion-item_info">
                                                        <span class="box-title"> Architecture in Paris</span>
                                                        <i class="fa-thin fa-angle-down"></i>
                                                    </span>

                                                </button>
                                            </div>
                                            <div id="collapse-4" class="accordion-collapse collapse " aria-labelledby="collapse-item-4" data-bs-parent="#offerDeals">
                                                <div class="accordion-body">
                                                    <span class="faq-price">$437.29</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="accordion-item-content">
                                    <div class="accordion-tab-item" data-bs-toggle="tab" data-bs-target="#tab5">
                                        <div class="accordion-item" data-img="{{asset('frontend/assets/img/normal/offer_img_5.jpg')}}">
                                            <div class="accordion-header" id="collapse-item-5">
                                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-5" aria-expanded="false" aria-controls="collapse-5">
                                                    <span class="accordion-item_info">
                                                        <span class="box-title">Caribbean, Maldives</span>
                                                        <i class="fa-thin fa-angle-down"></i>
                                                    </span>

                                                </button>
                                            </div>
                                            <div id="collapse-5" class="accordion-collapse collapse " aria-labelledby="collapse-item-5" data-bs-parent="#offerDeals">
                                                <div class="accordion-body">
                                                    <span class="faq-price">$2,333</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div id="tabs-content">
                                <div id="tab1" class="according-img-tab">
                                    <img src="{{asset('frontend/assets/img/normal/offer_img_1.jpg')}}" alt="">
                                </div>
                                <div id="tab2" class="according-img-tab">
                                    <img src="{{asset('frontend/assets/img/normal/offer_img_2.jpg')}}" alt="">
                                </div>
                                <div id="tab3" class="according-img-tab ">
                                    <img src="{{asset('frontend/assets/img/normal/offer_img_3.jpg')}}" alt="">
                                </div>
                                <div id="tab4" class="according-img-tab ">
                                    <img src="{{asset('frontend/assets/img/normal/offer_img_4.jpg')}}" alt="">
                                </div>
                                <div id="tab5" class="according-img-tab">
                                    <img src="{{asset('frontend/assets/img/normal/offer_img_5.jpg')}}" alt="">
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xl-5">
                    <div class="title-area pe-xl-5 me-xl-5">
                        <span class="sub-title">Last Discount for you</span>
                        <h2 class="sec-title">Offer Deals & Discount</h2>
                    </div>
                    <ul class="offer-deals-counter counter-list" data-offer-date="12/8/2024">
                        <li>
                    ...
                    <div class="mt-60">
                        <a href="contact.html" class="th-btn style3 th-icon">Get More Offer</a>
                    </div>
                </div>
            </div>
        </div>
    </div>
    <div class="shape-mockup movingX d-none d-xl-block" data-bottom="8%" data-left="5%">
        <img src="{{asset('frontend/assets/img/shape/shape_2_1.png')}}" alt="shape">
    </div>
</section>

<section class="tour-sec2 position-relative overflow-hidden bg-top-center z-index-3 space-top" id="tour-sec" data-pos-for=".counter-sec2" data-sec-pos="bottom-half" data-bg-src="{{asset('frontend/assets/img/bg/tour_bg_2.jpg')}}">
    <div class="container">
            ...
            <div class="swiper th-slider tourSlider2 slider-drag-wrap has-shadow" id="tourSlider2" data-slider-options='{"breakpoints":{"0":{"slidesPerView":1},"480":{"slidesPerView":2},"576":{"slidesPerView":"2"},"1199":{"slidesPerView":"3"},"1400":{"slidesPerView":"4"}}}'>
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="tour-card th-ani  gsap-cursor">
                            <div class="tour-card_img global-img">
                                <img src="{{asset('frontend/assets/img/tour/tour_2_1.jpg')}}" alt="image">
                            </div>
                            <div class="tour-content">
                                ...
                                <h4 class="tour-card_price"><span class="currency">$980.00</span>/Person</h4>
                    ...
                    <div class="swiper-slide">
                        <div class="tour-card th-ani  gsap-cursor">
                            <div class="tour-card_img global-img">
                                <img src="{{asset('frontend/assets/img/tour/tour_2_2.jpg')}}" alt="image">
                            </div>
                            <div class="tour-content">
                    ...
                    <div class="swiper-slide">
                        <div class="tour-card th-ani  gsap-cursor">
                            <div class="tour-card_img global-img">
                                <img src="{{asset('frontend/assets/img/tour/tour_2_3.jpg')}}" alt="image">
                            </div>
                            <div class="tour-content">
                    ...
                    <div class="swiper-slide">
                        <div class="tour-card th-ani  gsap-cursor">
                            <div class="tour-card_img global-img">
                                <img src="{{asset('frontend/assets/img/tour/tour_2_4.jpg')}}" alt="image">
                            </div>
                            <div class="tour-content">
...
<div class="counter-sec2 space" data-bg-src="{{asset('frontend/assets/img/bg/line-pattern2.png')}}">
    <div class="container">
        <div class="row">
    ...
    <div class="shape-mockup shape1 d-none d-xl-block" data-top="40%" data-left="2%">
        <img src="{{asset('frontend/assets/img/shape/shape_1.png')}}" alt="shape">
    </div>
    <div class="shape-mockup shape2 d-none d-xl-block" data-top="50%" data-left="2%">
    ...
    <div class="shape-mockup spin d-none d-xl-block" data-bottom="12%" data-right="19%">
        <img src="{{asset('frontend/assets/img/shape/shape_2_3.png')}}" alt="shape">
    </div>
    <div class="shape-mockup jump d-none d-xl-block" data-bottom="30%" data-right="4%">
        <img src="{{asset('frontend/assets/img/shape/shape_2_2.png')}}" alt="shape">
    </div>
    <div class="shape-mockup dance2 d-none d-xl-block" data-bottom="10%" data-right="3%">
        <img src="{{asset('frontend/assets/img/shape/shape_2_5.png')}}" alt="shape">
    </div>
</div>

<div class=" bg-top-center space" data-bg-src="{{asset('frontend/assets/img/bg/gallery_bg_1.jpg')}}">
    <div class="container">
        <div class="row justify-content-lg-between justify-content-center align-items-center">
            <div class="col-lg-7">
                <div class="title-area text-center text-lg-start mb-20 pe-xl-5 me-xl-5">
                    ...
                    <h2 class="sec-title">Explore the most beautiful place in the world</h2>
                </div>
                <p class="sec-text style2 text-title mb-50">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                    eiusmod tempor incididunt labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
                    exercitation.</p>
            </div>
            <div class="col-auto">
                <div class="sec-btn">
                    <a href="gallery.html" class="th-btn style3 th-icon">Enter Gallery</a>
                </div>
            </div>
        </div>
    </div>
    <div class="container th-container2">
        <div class="row gy-24 gx-24 justify-content-center">
            <div class="col-lg-3 gallery-box_wrapp">
                <div class="gallery-box">
                    <div class="gallery-img global-img">
                        <a href="{{asset('frontend/assets/img/gallery/gallery_2_1.jpg')}}" class="popup-image">
                            <div class="icon-btn"><i class="fal fa-magnifying-glass-plus"></i></div>
                            <img src="{{asset('frontend/assets/img/gallery/gallery_2_1.jpg')}}" alt="gallery image">
                        </a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 gallery-box_wrapp">
                <div class="gallery-box">
                    <div class="gallery-img global-img">
                        <a href="{{asset('frontend/assets/img/gallery/gallery_2_2.jpg')}}" class="popup-image">
                            <div class="icon-btn"><i class="fal fa-magnifying-glass-plus"></i></div>
                            <img src="{{asset('frontend/assets/img/gallery/gallery_2_2.jpg')}}" alt="gallery image">
                        </a>
                    </div>
                </div>
                <div class="gallery-box">
                    <div class="gallery-img global-img">
                        <a href="{{asset('frontend/assets/img/gallery/gallery_2_3.jpg')}}" class="popup-image">
                            <div class="icon-btn"><i class="fal fa-magnifying-glass-plus"></i></div>
                            <img src="{{asset('frontend/assets/img/gallery/gallery_2_3.jpg')}}" alt="gallery image">
                        </a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 gallery-box_wrapp">
                <div class="gallery-box">
                    <div class="gallery-img global-img">
                        <a href="{{asset('frontend/assets/img/gallery/gallery_2_4.jpg')}}" class="popup-image">
                            <div class="icon-btn"><i class="fal fa-magnifying-glass-plus"></i></div>
                            <img src="{{asset('frontend/assets/img/gallery/gallery_2_4.jpg')}}" alt="gallery image">
                        </a>
                    </div>
                </div>
                <div class="gallery-box">
                    <div class="gallery-img global-img">
                        <a href="{{asset('frontend/assets/img/gallery/gallery_2_5.jpg')}}" class="popup-image">
                            <div class="icon-btn"><i class="fal fa-magnifying-glass-plus"></i></div>
                            <img src="{{asset('frontend/assets/img/gallery/gallery_2_5.jpg')}}" alt="gallery image">
                        </a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 gallery-box_wrapp">
                <div class="gallery-box">
                    <div class="gallery-img global-img">
                        <a href="{{asset('frontend/assets/img/gallery/gallery_2_6.jpg')}}" class="popup-image">
                            <div class="icon-btn"><i class="fal fa-magnifying-glass-plus"></i></div>
                            <img src="{{asset('frontend/assets/img/gallery/gallery_2_6.jpg')}}" alt="gallery image">
                        </a>
                    </div>
                </div>
            </div>
...
<section class="testimonial-area2 overflow-hidden space" id="testi-sec">
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-xl-12">
                <div class="testi-review" data-bg-src="{{asset('frontend/assets/img/bg/map.png')}}">
                    <div class="testi-box hover-item  item-active">
                        ...
                        <div class="testi-box_profile">
                            <div class="testi-box_avater">
                                <span></span>
                                <img src="{{asset('frontend/assets/img/testimonial/testi_2_1.png')}}" alt="testimonial">
                            </div>
                            <div class="media-body">
                    ...
                    <div class="testi-box hover-item  ">
                        ...
                        <div class="testi-box_profile">
                            <div class="testi-box_avater">
                                <span></span>
                                <img src="{{asset('frontend/assets/img/testimonial/testi_2_2.png')}}" alt="testimonial">
                            </div>
                            <div class="media-body">
                    ...
                    <div class="testi-box hover-item  ">
                        ...
                        <div class="testi-box_profile">
                            <div class="testi-box_avater">
                                <span></span>
                                <img src="{{asset('frontend/assets/img/testimonial/testi_2_3.png')}}" alt="testimonial">
                            </div>
                            <div class="media-body">
                    ...
                    <div class="testi-box hover-item  ">
                        ...
                        <div class="testi-box_profile">
                            <div class="testi-box_avater">
                                <span></span>
                                <img src="{{asset('frontend/assets/img/testimonial/testi_2_4.png')}}" alt="testimonial">
                            </div>
                            <div class="media-body">
                    ...
                    <div class="testi-box hover-item  ">
                        ...
                        <div class="testi-box_profile">
                            <div class="testi-box_avater">
                                <span></span>
                                <img src="{{asset('frontend/assets/img/testimonial/testi_2_5.png')}}" alt="testimonial">
                            </div>
                            <div class="media-body">
    ...
    <div class="shape-mockup movingX d-none d-xl-block" data-top="30%" data-left="5%">
        <img class="gmovingX" src="{{asset('frontend/assets/img/shape/shape_7.png')}}" alt="shape">
    </div>
    <div class="shape-mockup spin d-none d-xl-block" data-bottom="30%" data-right="5%">
        <img src="{{asset('frontend/assets/img/shape/shape_2_5.png')}}" alt="shape">
    </div>
