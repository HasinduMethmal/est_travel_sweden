...
@section('content')
  <!--==============================
    Breadcumb
============================== -->
<div class="breadcumb-wrapper " data-bg-src="{{ asset('frontend/assets/img/bg/activitiesdebg.png') }}">
        <div class="container">
                ...
                <div class="col-xxl-8 col-lg-7">
                    <div class="tour-page-single">
                        <div class="slider-area tour-slider1">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img">
                                            <img src="{{ asset('frontend/assets/img/tour/tour_inner_2_1.jpg') }}" alt="img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img">
                                        <img src="{{ asset('frontend/assets/img/tour/tour_inner_2_2.jpg') }}" alt="img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img">
                                        <img src="{{ asset('frontend/assets/img/tour/tour_inner_2_3.jpg') }}" alt="img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img">
                                        <img src="{{ asset('frontend/assets/img/tour/tour_inner_2_4.jpg') }}" alt="img">
                                        </div>
                                    </div>
                            ...
                            <button data-slider-prev="#tourSlider4" class="slider-arrow style3 slider-prev"><img src="{{asset('frontend/assets/img/icon/hero-arrow-left.svg')}}" alt=""></button>
                            <button data-slider-next="#tourSlider4" class="slider-arrow style3 slider-next"><img src="{{asset('frontend/assets/img/icon/hero-arrow-right.svg')}}" alt=""></button>
                        </div>
                        <div class="page-content">
                            ...
                            <div class="tour-snapshot">
                                ...
                                <div class="tour-snap-wrapp">
                                    ...
                                    <div class="tour-snap">
                                        <div class="icon">
                                            <img src="{{asset('frontend/assets/img/icon/guide2.svg')}}" alt="">
                                        </div>
                                        <div class="content">
                                    ...
                                    <div class="tour-snap">
                                        <div class="icon">
                                            <img src="{{asset('frontend/assets/img/icon/ship.svg')}}" alt="">
                                        </div>
                                        <div class="content">
                                    ...
                                    <div class="tour-snap">
                                        <div class="icon">
                                            <img src="{{asset('frontend/assets/img/icon/01.svg')}}" alt="">
                                        </div>
                                        <div class="content">
                        ...
                        <div class="location-map">
                            ...
                            <div class="contact-map">
                                ...
                                <div class="contact-icon">
                                    <img src="{{asset('frontend/assets/img/icon/location-dot3.svg')}}" alt="">
                                </div>
                            </div>
                        </div>
